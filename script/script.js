...
/* --------- */
let menuItems,
  rowEmpanadas = document.querySelector("#row-empanadas"),
  ...
  validUser = { user: "berardomarcelo", pass: "marce2023" },
...
function createMenuCard(type, description, price, available, source) {
  ...
  switch (type) {
    case "Empanadas":
      rowEmpanadas.appendChild(divCol);
      break;
...
function createSettingsRow(type, description, price, available, source) {
  ...
  option1.value = "Empanadas";
  option1.textContent = "Empanadas";
